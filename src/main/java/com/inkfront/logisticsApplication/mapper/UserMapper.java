...
public abstract class UserMapper {
    ...
    public abstract User toEntity(UserUpdateRequestDTO userUpdateRequestDTO);
    ...
    @Mapping(target = "notifications", ignore = true)
    @Mapping(target = "auditLogs", ignore = true)
    public abstract void updateUserFromDTO(UserUpdateRequestDTO dto, @MappingTarget User user);
