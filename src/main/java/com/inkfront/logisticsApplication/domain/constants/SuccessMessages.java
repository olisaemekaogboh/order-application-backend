...
public class SuccessMessages {
    ...
    public static final String VERIFICATION_SUCCESS = "Email verified successfully";
    ...
    public static final String ORDER_ASSIGNED = "Driver assigned to order successfully";
    public static final String PRICE_CALCULATED = "Price calculated successfully";

    // Driver Success
    public static final String DRIVER_CREATED = "Driver created successfully";
